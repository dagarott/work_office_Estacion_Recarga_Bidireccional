...
tCanMsg Diccionario_CanOpen[] = {
    ...
    {OD_READ, 0x9000, 0x02, 4, 0x33445566}, //Io_Chademo. Current value read by ADC from Power Supply
    {OD_READ, 0x9000, 0x03, 4, 0x11110000}, //TempPos_Chademo. Positive Temperature value read by ADC
    {OD_READ, 0x9000, 0x04, 4, 0x00005555}, //TempNeg_Chademo. Negative Temperature value read by ADC
    //Debug
